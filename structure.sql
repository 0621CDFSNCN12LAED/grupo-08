...
VALUES (default,"Camiseta Barcelona Nike Tercer Recambio Stadium Verde","La camiseta de fútbol para hombre 3° Recambio Stadium del FC Barcelona 2019/20 está confeccionada con tela transpirable Dri-Fit que absorbe el sudor y te mantiene fresco, seco y cómodo tanto dentro como fuera de la cancha. El ajuste estándar hace que la prenda se adapte al cuerpo y ofrezca más espacio para mayor movilidad.", 123456789, "Cyan", 8199, "L", 100, 20),
(default, "Buzo color negro de alta calidad para esos días fríos","Diseñado por especialistas para los que aman el deporte todo el año y quieren tener siempre un buzo traspirable, de alta calidad y con estilo.", 123456789, "Negro", 6788, "M", 100, 10),
(default,
